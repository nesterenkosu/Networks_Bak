...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(9, 184);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(103, 184);
...
#pragma endregion
	...
	OurAddress.sin_port = htons(CLIENT_PORT);
...
private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		hSession = InternetConnect(hInet, Buf3, SERVER_PORT, NULL, NULL, INTERNET_SERVICE_HTTP, 0, 0);
		if (hSession == NULL) {
